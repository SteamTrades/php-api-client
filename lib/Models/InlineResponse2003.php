...
class InlineResponse2003 implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'trade_id' => 'string',
        'id_mapping' => '\SteamTrades\Models\ItemIdMapping[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['id_mapping'] = isset($data['id_mapping']) ? $data['id_mapping'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['trade_id'] === null) {
            $invalid_properties[] = "'trade_id' can't be null";
        }
        if ($this->container['id_mapping'] === null) {
            $invalid_properties[] = "'id_mapping' can't be null";
        }
    ...
    /**
     * Sets trade_id
     * @param string $trade_id ID of the newly created trade
     * @return $this
     */
    ...
    /**
     * Gets id_mapping
     * @return \SteamTrades\Models\ItemIdMapping[]
     */
    ...
    /**
     * Sets id_mapping
     * @param \SteamTrades\Models\ItemIdMapping[] $id_mapping Maps Steam asset IDs to our own, more consistent IDs. Asset IDs change on trades, our ID remains the same until the item leaves our system.
     * @return $this
     */
