...
/**
 * InventoryContext Class Doc Comment
 *
 * @category    Class
 * @description Information about an inventory context (filter) for a game.
 * @package     SteamTrades
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InventoryContext implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InventoryContext';
    ...
    /**
     * Sets id
     * @param string $id Our unique ID for this context
     * @return $this
     */
    ...
    /**
     * Sets steam_id
     * @param string $steam_id Steam's non-unique inventory context \"ID\"
     * @return $this
     */
