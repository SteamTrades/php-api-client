...
class InlineResponse2001 implements ArrayAccess
{
    ...
    /**
     * Sets completed
     * @param bool $completed `true` if the scan is completed, else `false`
     * @return $this
     */
    ...
    /**
     * Sets failed
     * @param bool $failed `true` if the scan failed, else `false`. Failure of inventory scans mostly happens due to private inventories.
     * @return $this
     */
